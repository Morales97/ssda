...
python main_SemiSup.py --seed=2 --steps_job=20000 --project=clean_SSL --expt_name=SemiSup_abl_PC --pixel_contrast=True --resume=expts/tmp_last/checkpoint_SemiSup_abl_PC_2.pth.tar
