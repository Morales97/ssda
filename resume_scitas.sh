...
#python main_SSDA.py --seed=1 --steps_job=20000 --project=clean_runs --expt_name=abl_PC_LAB --pixel_contrast=True --pc_mixed=False --lab_color=True --resume=expts/tmp_last/checkpoint_abl_PC_LAB_1.pth.tar
python main_SSDA.py --seed=2 --steps_job=20000 --project=clean_runs --expt_name=abl_colorblur --cr=ce --aug_level=7 --cutmix_cr=False --resume=expts/tmp_last/checkpoint_abl_colorblur_1.pth.tar
...
#python main_SSDA.py --seed=1 --steps=40000 --save_interval=40000 --steps_job=20000 --project=clean_runs --expt_name=abl_PC_nomix --pixel_contrast=True --pc_mixed=False --resume=expts/tmp_last/checkpoint_abl_PC_nomix_1.pth.tar
#python main_SSDA.py --seed=1 --steps=40000 --save_interval=40000 --steps_job=20000 --project=clean_runs --expt_name=abl_OH --cr=ce_oh --pixel_contrast=True --pc_mixed=False --resume=expts/tmp_last/checkpoint_abl_OH_1.pth.tar
...
#python main_SemiSup.py --seed=2 --steps=40000 --save_interval=40000 --steps_job=20000 --project=clean_SSL --expt_name=SemiSup_nomem_r3 --cr=ce --pixel_contrast=True --pc_memory=False --resume=expts/tmp_last/checkpoint_SemiSup_nomem_r3_2.pth.tar
