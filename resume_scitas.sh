...
python main_SSDA.py --seed=2 --steps_job=20000 --project=clean_runs --expt_name=abl_PC_LAB --pixel_contrast=True --pc_mixed=False --lab_color=True --resume=expts/tmp_last/checkpoint_abl_PC_LAB_2.pth.tar
