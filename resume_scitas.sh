...
# 2nd round
python main_SSDA.py --seed=2 --steps=40000 --save_interval=40000 --steps_job=20000 --project=clean_runs --expt_name=abl_noPCmix_r3 --cr=ce --pixel_contrast=True --pc_mixed=False --resume=expts/tmp_last/checkpoint_abl_noPCmix_r3_2.pth.tar
#python main_SSDA.py --seed=1 --steps=40000 --save_interval=40000 --steps_job=20000 --project=clean_runs --expt_name=abl_PC_nomix --pixel_contrast=True --pc_mixed=False -resume=expts/tmp_last/checkpoint_abl_noPCmix_r3_3.pth.tar
