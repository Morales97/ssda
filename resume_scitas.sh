...
# 2nd round
python main_SSDA.py --seed=2 --steps=40000 --save_interval=40000 --steps_job=20000 --project=clean_runs --expt_name=abl_noPCmix_r3 --cr=ce --pixel_contrast=True --resume=expts/tmp_last/checkpoint_abl_noPCmix_r3_2.pth.tar
...
#python main_SemiSup.py --seed=3 --steps=40000 --save_interval=40000 --steps_job=20000 --project=clean_SSL --expt_name=SemiSup_nomem_r3 --cr=ce --pixel_contrast=True --pc_memory=False --resume=expts/tmp_last/checkpoint_SemiSup_nomem_r3_3.pth.tar
