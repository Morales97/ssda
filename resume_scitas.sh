...
python main_SSDA.py --seed=3 --steps_job=20000 --project=clean_runs --expt_name=abl_PC_cycada --pixel_contrast=True --pc_mixed=False --gta_cycada=True --resume=expts/tmp_last/checkpoint_abl_PC_cycada_3.pth.tar
