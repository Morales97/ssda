...
# 2nd round
python main_SSDA.py --seed=1 --steps=40000 --save_interval=40000 --steps_job=20000 --project=clean_runs --expt_name=full_r2_prevEMA_p2_rm --cr=ce --pixel_contrast=True --prev_teacher=expts/tmp_last/checkpoint_full_p2_1.pth.tar --resume=expts/tmp_last/checkpoint_full_r2_prevEMA_1.pth.tar
