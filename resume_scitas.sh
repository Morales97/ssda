...
python main_SSDA_EMA.py --seed=3 --steps=40000 --save_interval=40000 --steps_job=20000 --project=GTA_to_CS_small --expt_name=full_EMAtrain_p2 --cr=ce --pixel_contrast=True --cutmix_cr=True --aug_level=5 --resume=expts/tmp_last/checkpoint_full_EMAtrain_3.pth.tar
