...
python main_SemiSup.py --seed=1 --steps_job=20000 --project=clean_SSL --expt_name=SemiSup_abl_CE --cr=ce --resume=expts/tmp_last/checkpoint_SemiSup_abl_CE_1.pth.tar
