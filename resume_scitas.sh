...
python main_SSDA.py --seed=1 --steps_job=20000 --project=clean_runs --expt_name=abl_randaug --cr=ce --aug_level=8 --cutmix_cr=False --resume=expts/tmp_last/checkpoint_abl_randaug_1.pth.tar
