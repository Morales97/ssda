...
python main_SSDA.py --seed=3 --steps=40000 --save_interval=40000 --steps_job=20000 --project=clean_runs --expt_name=abl_CE --cr=ce --resume=expts/tmp_last/checkpoint_abl_CE_3.pth.tar
