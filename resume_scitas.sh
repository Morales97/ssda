...
python main_SSDA.py --seed=1 --steps_job=20000 --project=clean_runs --expt_name=abl_cutmix --cr=ce --aug_level=0 --resume=expts/tmp_last/checkpoint_abl_cutmix_1.pth.tar
