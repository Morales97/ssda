...
python main_SSDA.py --seed=1 --steps=40000 --save_interval=40000 --steps_job=20000 --project=clean_runs --expt_name=abl_noPCmix_r2 --cr=ce --pixel_contrast=True --pc_mixed=False --resume=expts/tmp_last/checkpoint_abl_noPCmix_r2_1.pth.tar
