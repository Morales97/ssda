...
python main_SSDA.py --seed=2 --steps=40000 --save_interval=40000 --steps_job=20000 --project=clean_runs --expt_name=abl_LAB --cr=ce --pixel_contrast=True --lab_color=True --resume=expts/tmp_last/checkpoint_abl_LAB_2.pth.tar
