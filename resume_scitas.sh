...
python main_SSDA.py --seed=3 --steps=40000 --save_interval=40000 --steps_job=20000 --project=clean_runs --expt_name=abl_tau0.9_p2 --cr=ce_th --tau=0.9 --pixel_contrast=True --resume=expts/tmp_last/checkpoint_abl_tau0.9_3.pth.tar
...
#python main_SSDA_EMA.py --seed=3 --steps=40000 --save_interval=40000 --steps_job=20000 --project=clean_runs --expt_name=full_r2_p2_PL --cr=ce --pixel_contrast=True --resume=expts/tmp_last/checkpoint_full_r2_3.pth.tar --pseudolabel_folder=full_s3
...
# SSL
#python main_SemiSup.py --seed=3 --steps=30000 --save_interval=30000 --steps_job=10000 --project=GTA_to_CS_small --expt_name=SemiSup_r2_testNoPL_p2 --cr=ce --pixel_contrast=True --pc_memory=True --resume=expts/tmp_last/checkpoint_SemiSup_r2_testNoPL_3.pth.tar
