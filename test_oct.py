...
def main(args, wandb):
    ...
    t_loader = cityscapesLoader(image_path='data/cityscapes/leftImg8bit_tiny', label_path='data/cityscapes/gtFine', size="tiny", split='train', few_samples=100, rotation=False)
    #v_loader.test()
