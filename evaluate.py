...
if __name__ == '__main__':
    ...
    for seed in [1,2,3]:
        path_to_model_r2='expts/tmp_last/checkpoint_full_500_r2_' + str(seed) + '.pth.tar'  # round 2
        path_to_model_r3='expts/tmp_last/checkpoint_full_500_r3_' + str(seed) + '.pth.tar'  # round 3
