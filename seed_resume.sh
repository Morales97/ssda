...
python main_SSDA.py --seed=$1 --steps_job=20000 --project=clean_runs --expt_name=full_500_r2_nodrop --target_samples=500 --cr=ce --pixel_contrast=True --pseudolabel_folder=full_500_s$1 --resume=expts/tmp_last/checkpoint_full_500_r2_nodrop_$1.pth.tar 
