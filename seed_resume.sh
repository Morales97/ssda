...
python main_SSDA.py --seed=$1 --steps_job=20000 --project=clean_runs --expt_name=full_500_r2 --target_samples=500 --cr=ce --pixel_contrast=True --resume=expts/tmp_last/checkpoint_full_500_r2_$1.pth.tar
