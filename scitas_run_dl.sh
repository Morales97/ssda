...
python main_SSDA.py --save_model=False --project=GTA_to_CS_tiny --expt_name=COCO_pt --net=deeplabv3_rn50 --pre_trained=True --batch_size_s=4 --batch_size_tl=4 --batch_size_tu=4 --seed=1 #--custom_pretrain_path=model/pretrained/ckpt_mask_dlrn50_CS_400.tar
