...
python main_SSDA.py --project=GTA_to_CS_tiny --expt_name=CR_mask_CS --net=deeplabv3_rn50 --batch_size_s=4 --batch_size_tl=4 --batch_size_tu=4 --seed=1 --custom_pretrain_path=model/pretrained/ckpt_mask_dlrn50_CS.tar --cr=prob_distr #--pixel_contrast=True
