...
python main_SSDA.py --project=GTA_to_CS_tiny --expt_name=PC_CR_IN_bb --net=deeplabv3_rn50 --batch_size_s=4 --batch_size_tl=4 --batch_size_tu=4 --seed=1 --cr=prob_distr --pixel_contrast=True
