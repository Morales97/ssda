...
python main_SSDA.py --steps=1 --net=deeplabv3_rn50 --save_interval=1 --val_interval=1 --project=GTA_to_CS_small --size=tiny --expt_name=test --batch_size_s=2 --batch_size_tl=2 --batch_size_tu=2
