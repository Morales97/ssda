...
class cityscapesDataset(data.Dataset):
    ...
    def save_pred_viz(self, pred, index, img_name, img, lbl):
        ...
        pred_im.save('./data/cityscapes/predictions3/' + img_name + '_pred.png')
        import shutil
        shutil.copy(img_path, './data/cityscapes/predictions3/' + img_name + '_orig.png')
        shutil.copy(lbl_path, './data/cityscapes/predictions3/' + img_name + '_groundtruth.png')
