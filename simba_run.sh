...
# ----- Domain Adaptation -----
python main_S_and_T_2.py --project=GTA_to_CS_tiny --expt_name=dummy_100_mask_pt_CS_lr3 --net=deeplabv3_mask_pt --target_samples=100 --batch_size=8 --custom_pretrain_path=model/pretrained/checkpoint_39_mask_dlrn50.pth.tar --lr=0.001
