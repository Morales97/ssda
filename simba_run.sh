...
# python pretrain/rotation.py --batch_size=4 --lr=0.001 --project=rotation --expt_name=longer_run --save_dir=pretrain/expts_rot/tmp_last --save_interval=2000 --steps=10001
