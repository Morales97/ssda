...
python main_SSDA.py --project=GTA_CS_tiny_seeds --expt_name=CR_mask_pt_CS_GTA_sup_s1 --seed=1 --cr=prob_distr --custom_pretrain_path=model/pretrained/ckpt_mask_lraspp_CS_GTA_sup_s1.tar
