...
python main_SSDA.py --project=GTA_to_CS_tiny --expt_name=mask_pt_CS_GTA_sup --net=lraspp_mobilenet --target_samples=100 --batch_size=8  --custom_pretrain_path=model/pretrained/ckpt_masks_sup_lraspp_CS_GTA.tar
