...
# ----- Domain Adaptation -----
python main_S_and_T_2.py --project=GTA_to_CS_tiny --expt_name=mask_pt_PASCAL --net=deeplabv3_mask_pt --target_samples=100 --batch_size=8 --custom_pretrain_path=model/pretrained/model/pretrained/VOCSegmentation_supervised_saliency_model.pth.tar
