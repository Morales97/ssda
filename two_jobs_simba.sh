...
CUDA_VISIBLE_DEVICES=0 python main_SSDA.py --project=GTA_CS_tiny_seeds --expt_name=CR_CL_IN_bb --seed=2 --net=lraspp_mobilenet_contrast --pixel_contrast=True --gamma=0.1 --cr=prob_distr &
CUDA_VISIBLE_DEVICES=1 python main_SSDA.py --project=GTA_CS_tiny_seeds --expt_name=CR_CL_IN_bb --seed=3 --net=lraspp_mobilenet_contrast --pixel_contrast=True --gamma=0.1 --cr=prob_distr
