...
CUDA_VISIBLE_DEVICES=0 python main_SSDA.py --project=GTA_CS_tiny_seeds --expt_name=mask_pt_CS_sup_s1 --seed=1 --custom_pretrain_path=model/pretrained/ckpt_mask_lraspp_CS_sup_s1.tar &
CUDA_VISIBLE_DEVICES=1 python main_SSDA.py --project=GTA_CS_tiny_seeds --expt_name=CR_mask_pt_CS_sup_s1 --seed=1 --cr=prob_distr --custom_pretrain_path=model/pretrained/ckpt_mask_lraspp_CS_sup_s1.tar
