...
python main_SSDA.py --seed=1 --steps=40000 --save_interval=40000 --steps_job=20000 --project=clean_runs --expt_name=abl_tau0.9 --cr=ce_th --tau=0.9 --pixel_contrast=True 
