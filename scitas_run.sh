...
python main_SSDA.py --seed=3 --wandb=False --size=small --expt_name=KL_pc_40k --net=deeplabv2_rn101 --batch_size_s=2 --batch_size_tl=2 --batch_size_tu=2 --resume=model/pretrained/model_40k_KL_pc.tar
