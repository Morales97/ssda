...
python main_SSDA.py --seed=3 --steps=40000 --save_interval=40000 --steps_job=20000 --project=clean_runs --expt_name=abl_maskC --cr=ce --pixel_contrast=True --custom_pretrain=model/pretrained/ckpt_mask_v2.tar
