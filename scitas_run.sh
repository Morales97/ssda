...
python main_SSDA.py --project=GTA_CS_tiny_seeds --expt_name=CR_CL_COCO_bb --seed=2 --net=lraspp_mobilenet_contrast --pixel_contrast=True --gamma=0.1 --pre_trained=True --cr=prob_distr
