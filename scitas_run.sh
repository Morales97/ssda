...
python main_SemiSup.py --seed=3 --steps=40000 --save_interval=40000 --steps_job=20000 --project=clean_SSL --expt_name=SemiSup_nomem_p2 --cr=ce --pixel_contrast=True --pc_memory=False --pseudolabel_folder=SSnomem_s3
