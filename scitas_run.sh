...
# next round of ST
python main_SSDA.py --seed=1 --steps=40000 --save_interval=40000 --steps_job=20000 --project=clean_runs --expt_name=full_r2_prevEMA --cr=ce --pixel_contrast=True --pseudolabel_folder=full_s1 --prev_teacher=expts/tmp_last/checkpoint_full_p2_1.pth.tar
...
#python main_SemiSup.py --seed=1 --steps=30000 --save_interval=30000 --project=clean_runs --expt_name=SemiSup_r2 --cr=ce --pixel_contrast=True --pc_memory=True --dropPL_step=20000 --pseudolabel_folder=SS_s1
