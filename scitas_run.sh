...
# SSL
python main_SemiSup.py --seed=1 --steps=40000 --save_interval=40000 --steps_job=20000 --project=clean_SSL --expt_name=SemiSupNEW_500 --cr=ce --pixel_contrast=True --pc_memory=True --pc_ema=True --alpha=0.99
