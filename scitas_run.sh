...
python main_SemiSup.py --seed=3 --steps=30000 --save_interval=30000 --project=clean_runs --expt_name=SemiSup_r3 --cr=ce --pixel_contrast=True --pc_memory=True --dropPL_step=20000 --pseudolabel_folder=SS_r2_s3
