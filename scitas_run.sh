...
python main_SSDA.py --seed=2 --steps=40000 --save_interval=40000 --steps_job=20000 --project=clean_runs --expt_name=abl_OH --cr=ce_oh --pixel_contrast=True --pc_mixed=False 
