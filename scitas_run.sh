...
python main_SSDA.py --seed=3 --save_model=False --project=clean_rn50_tiny --expt_name=JS_ema_alo_base --net=deeplabv3_rn50 --batch_size_s=4 --batch_size_tl=4 --batch_size_tu=4 --cr=js --warmup_steps=0
