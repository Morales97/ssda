...
python main_SSDA.py --seed=2 --steps=40000 --save_interval=40000 --steps_job=20000 --project=clean_runs --expt_name=abl_tau0.9 --cr=ce_th --tau=0.9 --pixel_contrast=True 
...
#python main_SemiSup.py --seed=3 --steps=30000 --save_interval=30000 --steps_job=20000 --project=GTA_to_CS_small --expt_name=SemiSup_r2_testNoPL --cr=ce --pixel_contrast=True --pc_memory=True --pseudolabel_folder=SS_CE_pc_mem_s3
