...
# -- LR-ASPP --
#python main_S_and_T_2.py --project=GTA_to_CS_tiny --expt_name=mask_pt_CS_100sup_top5 --net=lraspp_mobilenet --target_samples=100 --batch_size=8 --custom_pretrain_path=model/pretrained/ckpt_mask_CS_100sup_top5.tar
python main_S_and_T_2.py --project=GTA_to_CS_tiny --expt_name=mask_pt_300_CS_GTA --net=lraspp_mobilenet --target_samples=100 --batch_size=8 --custom_pretrain_path=model/pretrained/ckpt_mask_lraspp_CS_GTA_300.tar
