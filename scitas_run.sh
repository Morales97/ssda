...
python main_SSDA.py --project=GTA_CS_tiny_seeds --expt_name=PC_mask_CS --seed=2 --net=lraspp_mobilenet_contrast --custom_pretrain_path=model/pretrained/checkpoint_mask_lraspp_CS_600.pth.tar
