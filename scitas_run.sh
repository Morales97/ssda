...
python main_SSDA.py --seed=1 --steps=200 --steps_job=100 --val_interval=100 --final_job=False --project=GTA_CS_rn50_tiny --expt_name=test_launch --net=deeplabv3_rn50 --batch_size_s=4 --batch_size_tl=4 --batch_size_tu=4 --cr=kl 
