...
python main_SSDA.py --project=GTA_to_CS_tiny_seeds --expt_name=CR_mask_pt_CS_GTA --seed=3 --net=lraspp_mobilenet --target_samples=100 --cr=prob_distr --custom_pretrain_path=model/pretrained/ckpt_mask_lraspp_CS_GTA_300.tar
