...
#python main_SSDA.py --seed=3 --steps_job=20000 --project=clean_runs --expt_name=abl_randaug --cr=ce --aug_level=8 --cutmix_cr=False
#python main_SSDA.py --seed=3 --steps_job=20000 --project=clean_runs --expt_name=abl_cutmix --cr=ce --aug_level=0

#python main_SSDA.py --seed=3 --steps_job=20000 --project=clean_runs --expt_name=abl_r2_dropPL --cr=ce --pixel_contrast=True --pseudolabel_folder=abl_noPCmix_s3
...
python main_SemiSup.py --seed=1 --steps_job=20000 --project=clean_SSL --expt_name=SemiSup_abl_PC --pixel_contrast=True
