...
python main_SemiSup.py --seed=2 --steps=30000 --save_interval=30000 --project=clean_runs --expt_name=SemiSup_r2 --cr=ce --pixel_contrast=True --pc_memory=True --pseudolabel_folder=SS_s2
