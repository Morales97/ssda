...
python main_SSDA.py --project=GTA_CS_tiny_seeds --expt_name=CL_COCO_bb --seed=3 --net=lraspp_mobilenet_contrast --pixel_contrast=True --gamma=0.1 --pre_trained=True
