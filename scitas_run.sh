...
python main_SSDA.py --project=GTA_CS_tiny_seeds --expt_name=CR_CL_mask_CS --seed=3 --net=lraspp_mobilenet_contrast --pixel_contrast=True --gamma=0.1 --cr=prob_distr --custom_pretrain_path=model/pretrained/checkpoint_mask_lraspp_CS_600.pth.tar
