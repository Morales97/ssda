...
python main_SemiSup.py --seed=$1 --steps_job=20000 --project=clean_SSL --expt_name=SemiSup_372_r2 --target_samples=372 --cr=ce --pixel_contrast=True --pseudolabel_folder=SS_372_s$1
