...
python main_SSDA.py --project=GTA_to_CS_tiny --expt_name=expt_3_CS_600 --net=lraspp_mobilenet --target_samples=100 --custom_pretrain_path=model/pretrained/checkpoint_mask_lraspp_CS_600.pth.tar
